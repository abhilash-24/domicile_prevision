...
public class Admin extends DAO 
{
	...
	public static double getPredictData22(String city, String area,
			String budget) 
	{
		ArrayList list=new ArrayList();
	double cf=0;
		try
		{
			...
			connection=database.connector();
			statement = connection.createStatement();
			String sql="select AVG(h_rssqft)  from house_dataset where h_city='"+city+"' and h_area='"+area+"' and h_rssqft<='"+budget+"'";
			System.out.println(sql);
			ResultSet rs=statement.executeQuery(sql);
			while(rs.next())
			{
	...
	public static double getcollaberativefiltereddata(String city) 
	{
		ArrayList list=new ArrayList();
		 double Cf=0;
		try
		{
			...
			connection=database.connector();
			statement = connection.createStatement();
			String sql="select AVG(h_rssqft)  from house_dataset where h_city='"+city+"' and h_year='"+2019+"'";
			System.out.println(sql);
			ResultSet rs=statement.executeQuery(sql);
			while(rs.next())
			{
