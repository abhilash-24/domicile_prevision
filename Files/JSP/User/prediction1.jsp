...
<body onload="startTimer()">
    ...
    %>
					<td><font style="color: maroon;font-weight: bold;">Linear Regression Prediction</font></td>
					<td></td>
					...
					<td></td>
					<td><font style="color: maroon;font-weight: bold;"><%=CF%> per Sqft</font></td>
					</tr>
					<div>
					
					<a href="graph1.jsp?LR=<%=prediction1%>&CF=<%=CF%>">View Graph</a>
					</div>
					<%} %>
					</tr>
